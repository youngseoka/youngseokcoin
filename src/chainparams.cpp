...
{
    const char* pszTimestamp = "No amount of money ever bought a second of time";
...
public:
    CMainParams() {
        ...
        vSeeds.emplace_back("dnsseed.youngseokcoin.dashjr.org", false); // Luke Dashjr
        vSeeds.emplace_back("seed.youngseokcoinstats.com", true); // Christian Decker, supports x1 - xf
        vSeeds.emplace_back("seed.youngseokcoin.jonasschnelli.ch", true); // Jonas Schnelli, only supports x1, x5, x9, and xd
        vSeeds.emplace_back("seed.ysc.petertodd.org", true); // Peter Todd, only supports x1, x5, x9, and xd
*/
...
public:
    CTestNetParams() {
        ...
        consensus.fPowNoRetargeting = false;
        consensus.nRuleChangeActivationThreshold = 137; // 75% for testchains
        consensus.nMinerConfirmationWindow = 144; // nPowTargetTimespan / nPowTargetSpacing
        consensus.vDeployments[Consensus::DEPLOYMENT_TESTDUMMY].bit = 28;
      ...
      /*  vSeeds.emplace_back("testnet-seed.youngseokcoin.jonasschnelli.ch", true);
        vSeeds.emplace_back("seed.tysc.petertodd.org", true);
